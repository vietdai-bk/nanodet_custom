...
from .shufflenet_custom import UltraFastShuffleNetV2
...
def build_backbone(cfg):
    ...
    if name == "ResNet":
        ...
        return PPLCNet(**backbone_cfg)
    elif name == "MobileNetV3":
        return MobileNetV3(**backbone_cfg)
    elif name == "UltraFastShuffleNetV2":
        return UltraFastShuffleNetV2(**backbone_cfg)
    else:
